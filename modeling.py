...
def tfidf_matrix(series):
    vectorizer = TfidfVectorizer(max_df = 0.8, min_df = 2, preprocessor = tp.custom_preprocessor, tokenizer = tp.custom_tokenizer, stop_words=custom_stop_words(), lowercase=True)
