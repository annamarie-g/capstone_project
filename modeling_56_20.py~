...
def tfidf_matrix(series):
    vectorizer = TfidfVectorizer(max_df = 0.70, min_df = 5, preprocessor = tp.custom_preprocessor, tokenizer = tokenizer_helper,  stop_words=stopwords.words('english'), lowercase=True)
