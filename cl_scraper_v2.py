...
def scrape_posting(location_tuple, category_tuple, url): 
    ...
    if postingbody: 
        ...
        post_dict['postbody_contents'] = postingbody.contents.encode('utf8')
...
def to_mongo(posting_dictionary): 
    '''Exports dictionary of posting information to MongoDB
    '''
        ...
        for category_tuple in category_tuples:
            ...
            for page_url in cat_page_urls: 
                ...
                for post_url in post_urls: 
                    posting_dictonary = scrape_posting(location_tuple, category_tuple, post_url)
                    to_mongo(posting_dictionary) 
